...
CREATE TABLE "public"."itens_inventario" (
    ...
    "cadastrado_durante_inventario" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "servidores_inventarioId_nome_key" ON "public"."servidores"("inventarioId", "nome");
...
-- AddForeignKey
ALTER TABLE "public"."servidores" ADD CONSTRAINT "servidores_inventarioId_fkey" FOREIGN KEY ("inventarioId") REFERENCES "public"."inventarios"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
